...
public final class Registry {
	 ...
	 */
	public synchronized void bind(ThreadEndpoint endpoint) {
	 ...
	 */
	public synchronized void unbind(ThreadEndpoint endpoint) {
	...
	/**
	 * This method looks up the {@link ThreadEndpoint endpoint}for the node
	 * with the given name. If no endpoint is found <code>null</code> is
	 * returned.
	 * 
	 * @param url
	 ...
	 */
	public synchronized ThreadEndpoint lookup(URL url) {
	 ...
	 */
	public synchronized Map<URL, ThreadEndpoint> lookupAll() {
		return java.util.Collections.unmodifiableMap(this.registeredEndpoints); 
	}
